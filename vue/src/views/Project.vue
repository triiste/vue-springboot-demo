<template>
    <div style="padding: 10px">
        ...
        <!--<div style="margin: 10px 0">-->
            ...
            <!--</el-button>-->
        <!--</div>-->
        <el-select v-model="searchType" size="large" clearable placeholder="请选择要查询的类型">
            <el-option
...
<script>
    ...
    export default {
        ...
        methods: {
            // check(){
            //     form.first=form.projectMark*from.first;
            // },
            load() {
                if(this.searchType === '1'){
                    ...
                    request.get("/project/findnamePage", {
                        params: {
                            pageNum: this.currentPage,
                            pageSize: this.pageSize,
                            search: this.search
                    ...
                    request.get("/project/findproPage", {
                        params: {
                            pageNum: this.currentPage,
                            pageSize: this.pageSize,
                            search: this.search
