<template>
    <div style="padding: 10px">
        ...
        <el-table :data="tableData" stripe border  style="width: 100%">
            ...
            <el-table-column prop="scientific" label="科研处确认情况" sortable >
                <!--prop是该变量显示的内容-->
                <template #default="scope">
            ...
            <el-table-column fixed="right" label="操作" width="120" v-if="this.user.role != 1">
                <template #default="scope">
                    ...
                    <el-button link type="primary" size="small" @click="handleEdit(scope.row) " v-if="scope.row.scientific === 0" >确认</el-button>
                    <el-button link type="primary" size="small" @click="handleEdit(scope.row) " v-if="scope.row.scientific === 1" >取消确认</el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    export default {
        ...
        methods:{
            ...
            save(){
                ...
                //把表单传给后台
                //穿表单给后台
                request.put("/group/science", this.form).then(res =>{//.then是es6里的语法
                    console.log(res);
                    if(res.code === '0'){
